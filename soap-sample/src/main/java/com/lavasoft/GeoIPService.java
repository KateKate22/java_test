 ...
 * 2023-04-11T09:45:05.973+03:00
 * Generated source version: 4.0.0
 *
 */
@WebServiceClient(name = "GeoIPService",
                  wsdlLocation = "E:/QA_auto/java_test/soap-sample/src/main/resources/geoipservice.wsdl",
...
public class GeoIPService extends Service {
    ...
    static {
        URL url = GeoIPService.class.getResource("E:/QA_auto/java_test/soap-sample/src/main/resources/geoipservice.wsdl");
        if (url == null) {
            url = GeoIPService.class.getClassLoader().getResource("E:/QA_auto/java_test/soap-sample/src/main/resources/geoipservice.wsdl");
        }
        if (url == null) {
            java.util.logging.Logger.getLogger(GeoIPService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "E:/QA_auto/java_test/soap-sample/src/main/resources/geoipservice.wsdl");
        }
        WSDL_LOCATION = url;
    }
